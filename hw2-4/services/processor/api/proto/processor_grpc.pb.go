...
func (c *processorServiceClient) GetRepository(ctx context.Context, in *RepoRequest, opts ...grpc.CallOption) (*RepoResponse, error) {
...
func (UnimplementedProcessorServiceServer) GetRepository(context.Context, *RepoRequest) (*RepoResponse, error) {
...
func _ProcessorService_GetRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProcessorServiceServer).GetRepository(ctx, req.(*RepoRequest))
	}
